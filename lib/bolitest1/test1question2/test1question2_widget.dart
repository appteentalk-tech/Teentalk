...
import 'test1question2_model.dart';
export 'test1question2_model.dart';

class Test1question2Widget extends StatefulWidget {
  const Test1question2Widget({super.key});

  static String routeName = 'test1question2';
  static String routePath = '/teste1question2';

  @override
  State<Test1question2Widget> createState() => _Test1question2WidgetState();
}

class _Test1question2WidgetState extends State<Test1question2Widget> {
  late Test1question2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test1question2Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed(
                          Test1question3Widget.routeName,
