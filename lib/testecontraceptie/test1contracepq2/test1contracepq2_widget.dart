...
import 'test1contracepq2_model.dart';
export 'test1contracepq2_model.dart';

class Test1contracepq2Widget extends StatefulWidget {
  const Test1contracepq2Widget({super.key});

  static String routeName = 'test1contracepq2';
  static String routePath = '/testecontracep2';

  @override
  State<Test1contracepq2Widget> createState() => _Test1contracepq2WidgetState();
}

class _Test1contracepq2WidgetState extends State<Test1contracepq2Widget> {
  late Test1contracepq2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test1contracepq2Model());
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 20.0),
                                          child: Text(
                                            'Which method provides protection against both pregnancy and infections?',
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
                                                  fontFamily: 'The seasons',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.goNamed(
                          Test1contracepq3Widget.routeName,
