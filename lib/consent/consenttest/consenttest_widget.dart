...
import 'consenttest_model.dart';
export 'consenttest_model.dart';

class ConsenttestWidget extends StatefulWidget {
  const ConsenttestWidget({super.key});

  static String routeName = 'consenttest';
  static String routePath = '/consenttest';
...
class _ConsenttestWidgetState extends State<ConsenttestWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsenttestModel());
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 50.0, 0.0, 0.0),
                                          child: wrapWithModel(
                                            model: _model.testeconsentModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: TesteconsentWidget(),
                                          ),
                                        ),
                                      ],
                                    ),
