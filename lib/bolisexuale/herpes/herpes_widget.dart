...
import 'herpes_model.dart';
export 'herpes_model.dart';

class HerpesWidget extends StatefulWidget {
  const HerpesWidget({super.key});

  static String routeName = 'HERPES';
  static String routePath = '/herpes';

  @override
  State<HerpesWidget> createState() => _HerpesWidgetState();
}

class _HerpesWidgetState extends State<HerpesWidget> {
  late HerpesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HerpesModel());
                        ...
                        Align(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-0.42, -0.74),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      20.0, 20.0, 0.0, 0.0),
                                  child: Text(
