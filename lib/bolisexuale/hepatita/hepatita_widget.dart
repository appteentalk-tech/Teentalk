...
import 'hepatita_model.dart';
export 'hepatita_model.dart';

class HepatitaWidget extends StatefulWidget {
  const HepatitaWidget({super.key});

  static String routeName = 'HEPATITA';
  static String routePath = '/hepatita';

  @override
  State<HepatitaWidget> createState() => _HepatitaWidgetState();
}

class _HepatitaWidgetState extends State<HepatitaWidget> {
  late HepatitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HepatitaModel());
                            ...
                            Align(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.63, -0.74),
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 20.0, 0.0, 0.0),
                                      child: Text(
