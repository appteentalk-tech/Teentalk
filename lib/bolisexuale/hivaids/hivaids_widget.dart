...
import 'hivaids_model.dart';
export 'hivaids_model.dart';

class HivaidsWidget extends StatefulWidget {
  const HivaidsWidget({super.key});

  static String routeName = 'HIVAIDS';
  static String routePath = '/hivaids';

  @override
  State<HivaidsWidget> createState() => _HivaidsWidgetState();
}

class _HivaidsWidgetState extends State<HivaidsWidget> {
  late HivaidsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HivaidsModel());
