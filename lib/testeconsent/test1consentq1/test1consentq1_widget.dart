...
import 'test1consentq1_model.dart';
export 'test1consentq1_model.dart';

class Test1consentq1Widget extends StatefulWidget {
  const Test1consentq1Widget({super.key});

  static String routeName = 'test1consentq1';
  static String routePath = '/testeconsent1';

  @override
  State<Test1consentq1Widget> createState() => _Test1consentq1WidgetState();
}

class _Test1consentq1WidgetState extends State<Test1consentq1Widget> {
  late Test1consentq1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test1consentq1Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.goNamed(
                          Test1consentq2Widget.routeName,
