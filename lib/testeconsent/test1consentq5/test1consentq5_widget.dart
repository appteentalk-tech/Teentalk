...
import 'test1consentq5_model.dart';
export 'test1consentq5_model.dart';

class Test1consentq5Widget extends StatefulWidget {
  const Test1consentq5Widget({super.key});

  static String routeName = 'test1consentq5';
  static String routePath = '/testeconsent5';

  @override
  State<Test1consentq5Widget> createState() => _Test1consentq5WidgetState();
}

class _Test1consentq5WidgetState extends State<Test1consentq5Widget> {
  late Test1consentq5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test1consentq5Model());
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 20.0),
                                            child: Text(
                                              'What should you do before any interaction?',
