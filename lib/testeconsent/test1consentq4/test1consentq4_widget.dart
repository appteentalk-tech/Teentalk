...
import 'test1consentq4_model.dart';
export 'test1consentq4_model.dart';

class Test1consentq4Widget extends StatefulWidget {
  const Test1consentq4Widget({super.key});

  static String routeName = 'test1consentq4';
  static String routePath = '/testeconsent4';

  @override
  State<Test1consentq4Widget> createState() => _Test1consentq4WidgetState();
}

class _Test1consentq4WidgetState extends State<Test1consentq4Widget> {
  late Test1consentq4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Test1consentq4Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.goNamed(
                          Test1consentq5Widget.routeName,
